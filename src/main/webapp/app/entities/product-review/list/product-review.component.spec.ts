...
describe('ProductReview Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'product-review', component: ProductReviewComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.productReviews?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
