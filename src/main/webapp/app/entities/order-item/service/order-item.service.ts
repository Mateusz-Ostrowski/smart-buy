...
export class OrderItemService {
  ...
  protected convertDateFromClient(orderItem: IOrderItem): IOrderItem {
    return Object.assign({}, orderItem, {
      createdAt: orderItem.createdAt?.isValid() ? orderItem.createdAt.toJSON() : undefined,
      updatedAt: orderItem.updatedAt?.isValid() ? orderItem.updatedAt.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((orderItem: IOrderItem) => {
        orderItem.createdAt = orderItem.createdAt ? dayjs(orderItem.createdAt) : undefined;
        orderItem.updatedAt = orderItem.updatedAt ? dayjs(orderItem.updatedAt) : undefined;
      });
    }
    return res;
  }
