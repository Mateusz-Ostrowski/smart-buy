...
export class CategoryService {
  ...
  protected publicUrl = this.applicationConfigService.getEndpointFor('api/public/categories');
  ...
  getPublicCategories(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http.get<ICategory[]>(this.publicUrl, { params: options, observe: 'response' });
  }
