...
import com.sysect.smartbuy.repository.CustomerRepository;
import com.sysect.smartbuy.service.dto.CustomerDTO;
import com.sysect.smartbuy.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
        return customer;
    }
