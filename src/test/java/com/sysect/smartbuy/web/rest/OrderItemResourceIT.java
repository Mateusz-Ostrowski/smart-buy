...
import com.sysect.smartbuy.repository.OrderItemRepository;
import com.sysect.smartbuy.service.dto.OrderItemDTO;
import com.sysect.smartbuy.service.mapper.OrderItemMapper;
...
class OrderItemResourceIT {
    ...
    void putNewOrderItem() throws Exception {
        ...
        updatedOrderItem.price(UPDATED_PRICE).quantity(UPDATED_QUANTITY).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.price(UPDATED_PRICE).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void fullUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.price(UPDATED_PRICE).quantity(UPDATED_QUANTITY).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
